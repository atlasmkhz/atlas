...
const MARKER_SVG = {
  ...
  // 의열투쟁 — 조준 표적
  righteous: '<circle cx="12" cy="12" r="7" stroke="currentColor" stroke-width="2" fill="none"/><circle cx="12" cy="12" r="2.4" fill="currentColor"/>',
  // 정치·언론 — 깃대 위 깃발
  ...
  // 일제 공작 — 감시의 눈
  plot: '<path d="M3 12s3.5-6 9-6 9 6 9 6-3.5 6-9 6-9-6-9-6z" stroke="currentColor" stroke-width="1.8" fill="none"/><circle cx="12" cy="12" r="2.6" fill="currentColor"/>',
  // 식민 정책 — 문서/날인
  policy: '<rect x="6" y="4" width="12" height="16" rx="1.5" stroke="currentColor" stroke-width="1.8" fill="none"/><path d="M9 9h6M9 12h6M9 15h4" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/>',
  // 학살 — 불꽃
