...
// — 고려시대에도 political/battle/plot/policy/culture/person 등 기존
// 유형으로 충분히 분류 가능해 markerIcons.js를 건드리지 않았다.
const COLORS = {
...
[
  ...
  (typeof EVENTS_HYEJONG !== 'undefined' ? EVENTS_HYEJONG : []),
  (typeof EVENTS_JEONGJONG_GORYEO !== 'undefined' ? EVENTS_JEONGJONG_GORYEO : []),
  (typeof EVENTS_GWANGJONG !== 'undefined' ? EVENTS_GWANGJONG : []),
  (typeof EVENTS_GYEONGJONG_GORYEO !== 'undefined' ? EVENTS_GYEONGJONG_GORYEO : []),
  (typeof EVENTS_SEONGJONG_GORYEO !== 'undefined' ? EVENTS_SEONGJONG_GORYEO : []),
  (typeof EVENTS_MOKJONG !== 'undefined' ? EVENTS_MOKJONG : []),
  (typeof EVENTS_HYEONJONG_GORYEO !== 'undefined' ? EVENTS_HYEONJONG_GORYEO : []),
  (typeof EVENTS_DEOKJONG !== 'undefined' ? EVENTS_DEOKJONG : []),
  (typeof EVENTS_JEONGJONG2 !== 'undefined' ? EVENTS_JEONGJONG2 : []),
  (typeof EVENTS_MUNJONG_GORYEO !== 'undefined' ? EVENTS_MUNJONG_GORYEO : []),
  (typeof EVENTS_SUNJONG_GORYEO !== 'undefined' ? EVENTS_SUNJONG_GORYEO : []),
  (typeof EVENTS_SEONJONG_GORYEO !== 'undefined' ? EVENTS_SEONJONG_GORYEO : []),
  (typeof EVENTS_HEONJONG_GORYEO !== 'undefined' ? EVENTS_HEONJONG_GORYEO : []),
  (typeof EVENTS_SUKJONG_GORYEO !== 'undefined' ? EVENTS_SUKJONG_GORYEO : []),
  (typeof EVENTS_YEJONG_GORYEO !== 'undefined' ? EVENTS_YEJONG_GORYEO : []),
  (typeof EVENTS_INJONG_GORYEO !== 'undefined' ? EVENTS_INJONG_GORYEO : []),
  (typeof EVENTS_UIJONG !== 'undefined' ? EVENTS_UIJONG : []),
  (typeof EVENTS_MYEONGJONG !== 'undefined' ? EVENTS_MYEONGJONG : []),
  (typeof EVENTS_SINJONG !== 'undefined' ? EVENTS_SINJONG : []),
  (typeof EVENTS_HUIJONG !== 'undefined' ? EVENTS_HUIJONG : []),
  (typeof EVENTS_GANGJONG !== 'undefined' ? EVENTS_GANGJONG : []),
  (typeof EVENTS_GOJONG_GORYEO !== 'undefined' ? EVENTS_GOJONG_GORYEO : []),
  (typeof EVENTS_WONJONG !== 'undefined' ? EVENTS_WONJONG : []),
  (typeof EVENTS_CHUNGNYEOLWANG !== 'undefined' ? EVENTS_CHUNGNYEOLWANG : []),
  (typeof EVENTS_CHUNGSEONWANG !== 'undefined' ? EVENTS_CHUNGSEONWANG : []),
  (typeof EVENTS_CHUNGSUKWANG !== 'undefined' ? EVENTS_CHUNGSUKWANG : []),
  (typeof EVENTS_CHUNGHYEWANG !== 'undefined' ? EVENTS_CHUNGHYEWANG : []),
...
window.onload = () => {
  requestAnimationFrame(() => {
    ...
    setTimeout(() => {
      ...
      // 범위(918~1392) 밖이면 가장 가까운 경계 연도로 clamp한다.
