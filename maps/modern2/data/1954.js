...
const EVENTS_1954 = [
  ...
  { id:'organization_1954_03', year:1954, visible_from:1954, visible_until:1955,
    month:5, day:1, type:'organization', priority:2,
    title_ko:'통일교 창립 — 세계기독교통일신령협회',
    title_en:'Founding of the Unification Church',
    title_ja:'統一教会創立',
    place_ko:'서울',
    lat:37.5665, lng:126.9780,
    people:['문선명'],
    summary_ko:'1954년 5월 문선명이 서울에서 세계기독교통일신령협회(통일교, 현 세계평화통일가정연합)를 창립했다. 정통 개신교계로부터 이단으로 규정받았으나, 이후 한국을 넘어 언론·대학·제조업 등 방대한 사업체를 거느린 세계적 조직으로 성장했고 냉전기 반공 운동과 국제 정치에 깊이 관여했다. 훗날 2022년 일본 아베 신조 전 총리 피격 사건의 범인이 통일교 관련 동기를 밝히면서 통일교와 일본 정계의 유착 문제가 국제적 파문으로 번졌고, 한국에서도 정치권 인사와의 금품 의혹이 수사·재판 대상이 됐다 — 다만 상당수는 진행 중이거나 관련자별로 결론이 갈리는 사안이다. 종교 조직이 자본·정치와 결합할 때의 구조적 문제를 보여주는 사례로 남아 있다.',
    video:null,
    connections:[],
    tags:['organization','서울','통일교','문선명','신흥종교'],
    sources:['한국민족문화대백과사전 통일교','위키백과 세계평화통일가정연합'] },
