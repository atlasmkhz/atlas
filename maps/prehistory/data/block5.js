...
const EVENTS_BLOCK5 = [
  { id:'migration_north_01', year:-350, visible_from:-1000, visible_until:200,
    ...
    people:[],
    summary_ko:'만주 송화강 유역에는 부여라 불린 집단이 거주했다고 전해진다. 이 시기는 아직 뚜렷한 국가 체제 이전으로, 정확한 경계나 통치 구조를 특정하기는 어렵다. 다만 중국 사서(삼국지 위서 동이전)에 따르면 이후 부여는 왕 아래 마가·우가·저가·구가라는 관리들이 저마다 별도의 행정 구역(사출도)을 다스리는 독특한 체제를 갖췄고, 매년 12월 영고라는 제천 행사를 열었으며, 지배층이 죽으면 다른 사람을 함께 묻는 순장 풍습과 도둑질하면 훔친 물건의 12배를 물게 하는 1책12법 같은 엄격한 형벌이 있었다고 전한다. 부여는 이후 기원전후 무렵 보다 뚜렷한 정치체로 성장하며, 고구려·백제 왕실이 스스로 부여 계통이라 자처하는 등 이후 삼국 형성에도 영향을 미친 것으로 논의된다. 부여는 이런 만주의 여러 집단 가운데 가장 먼저 부족연맹을 넘어 초기국가 단계로 나아간 정치체로 평가된다 — 왕이 있었지만 마가·우가·저가·구가 등 부족장(가)들이 각자의 영역을 다스리며 왕권을 나눠 갖는, 아직 느슨한 국가였다.',
    video:null,
    connections:[],
