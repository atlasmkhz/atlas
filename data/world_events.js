...
const WORLD_EVENTS = {
  ...
  // ─────────── 과학 — 양자역학 100년 ───────────
  // 자료실 > 세계사 > 과학사 「양자역학 100년」 시리즈,
  // archive/world-routes/quantum-mechanics.html 루트와 짝을 이루는
  // 지도 레이어. 2025~2027년이 양자역학 탄생(1925~1927) 100주년이다.

  world_1900_planck: {
    id:'world_1900_planck', title:'플랑크의 양자 가설 — 양자의 세기가 열리다', start:1900, end:1900,
    regionKey:'europe', region:'유럽 (독일 베를린)', location:[52.5163, 13.3777],
    type:'TECH', visual:'radiate', priority:2,
    summary:{
      what:'베를린의 막스 플랑크가 흑체복사 문제를 풀기 위해 에너지가 연속적이 아니라 "양자"라는 덩어리 단위로만 주고받아진다고 가정했다. 본인은 이를 "절망의 행동"이라 불렀다.',
      why:'물질과 빛에 대한 인류의 상식을 뒤집는 20세기 물리학 혁명이 이 궁여지책 하나에서 시작되었다.',
      changed:'이 가설은 아인슈타인의 광양자, 보어의 원자모형을 거쳐 사반세기 뒤 양자역학이라는 완전히 새로운 물리학으로 자라난다.'
    },
    figures:[{name:'막스 플랑크', role:'양자 가설 제창'}]
  },

  world_1905_einstein: {
    id:'world_1905_einstein', title:'아인슈타인의 기적의 해', start:1905, end:1905,
    regionKey:'europe', region:'유럽 (스위스 베른)', location:[46.948, 7.4474],
    type:'TECH', visual:'radiate', priority:2,
    summary:{
      what:'베른 특허청의 26세 심사관 아인슈타인이 광양자 가설·브라운 운동·특수상대성이론·E=mc²의 네 논문을 한 해에 쏟아냈다.',
      why:'빛이 알갱이이기도 하다는 광양자 가설은 플랑크의 양자를 실재로 밀어붙인 양자역학의 진짜 첫걸음이었다.',
      changed:'시간·공간·빛·물질에 대한 물리학의 기초가 한 해 만에 다시 쓰였다. 같은 해 대한제국은 을사늑약으로 외교권을 잃고 있었다.'
    },
    figures:[{name:'알베르트 아인슈타인', role:'특허청 3급 심사관'}]
  },

  world_1911_solvay1: {
    id:'world_1911_solvay1', title:'제1차 솔베이 회의 — 물리학의 첫 정상회담', start:1911, end:1911,
    regionKey:'europe', region:'유럽 (벨기에 브뤼셀)', location:[50.8514, 4.3556],
    type:'TECH', visual:'flow', priority:3,
    summary:{
      what:'기업가 에르네스트 솔베이의 후원으로 유럽 정상급 물리학자들이 브뤼셀에 모여 "복사와 양자" 문제를 토론했다. 마리 퀴리가 유일한 여성 참석자였다.',
      why:'국경을 넘어 "문제 하나"를 놓고 모이는 국제 학술회의라는 형식 자체가 새로운 발명이었다.',
      changed:'고전물리학으로는 안 된다는 위기감이 공유되었고, 솔베이 회의는 이후 20세기 물리학의 정상회담으로 자리 잡는다.'
    },
    figures:[{name:'마리 퀴리', role:'유일한 여성 참석자'},{name:'헨드릭 로런츠', role:'의장'}]
  },

  world_1913_bohr: {
    id:'world_1913_bohr', title:'보어의 원자모형 — 원자 속의 양자 도약', start:1913, end:1913,
    regionKey:'europe', region:'유럽 (덴마크 코펜하겐)', location:[55.6805, 12.5714],
    type:'TECH', visual:'radiate', priority:3,
    summary:{
      what:'27세의 닐스 보어가 전자는 정해진 궤도만 돌 수 있고 궤도 사이를 "도약"할 때 빛을 낸다는 새 원자모형을 발표했다.',
      why:'플랑크·아인슈타인의 양자를 원자의 구조 속에 정면으로 들여놓아, 원자가 왜 무너지지 않는지를 처음 설명했다.',
      changed:'보어가 세운 코펜하겐 연구소는 하이젠베르크 등 젊은 천재들이 모여드는 양자역학의 수도가 된다.'
    },
    figures:[{name:'닐스 보어', role:'원자모형 제창'},{name:'어니스트 러더퍼드', role:'스승·원자핵 발견'}]
  },

  world_1925_quantum_birth: {
    id:'world_1925_quantum_birth', title:'양자역학의 탄생 — 헬골란트에서 취리히까지', start:1925, end:1926,
    regionKey:'europe', region:'유럽 (독일·스위스)', location:[54.1833, 7.8833],
    type:'TECH', visual:'radiate', priority:2,
    summary:{
      what:'1925년 여름 하이젠베르크가 북해의 헬골란트 섬에서 행렬역학을 착상하고, 1926년 취리히의 슈뢰딩거가 파동방정식을 완성했다. 괴팅겐의 보른은 파동함수가 "확률"을 뜻한다는 해석을 보탰다.',
      why:'사반세기의 균열이 마침내 완결된 새 역학으로 태어난 순간이다 — 2025년 세계가 기념한 "양자 100주년"의 기준점.',
      changed:'자연의 근본 법칙이 확정된 미래가 아니라 확률만을 말한다는 세계관의 전환이 일어났고, 아인슈타인은 평생의 반대자가 된다.'
    },
    figures:[{name:'베르너 하이젠베르크', role:'행렬역학'},{name:'에르빈 슈뢰딩거', role:'파동방정식'},{name:'막스 보른', role:'확률 해석'}]
  },

  world_1927_solvay5: {
    id:'world_1927_solvay5', title:'제5차 솔베이 회의 — 아인슈타인·보어 논쟁', start:1927, end:1930,
    regionKey:'europe', region:'유럽 (벨기에 브뤼셀)', location:[50.8467, 4.372],
    type:'TECH', visual:'flow', priority:2,
    summary:{
      what:'참석자 29명 중 17명이 노벨상 수상자였던 1927년 브뤼셀 회의에서, 아인슈타인이 아침마다 양자역학을 무너뜨릴 사고실험을 내놓고 보어가 저녁마다 반박하는 세기의 논쟁이 벌어졌다.',
      why:'"신은 주사위를 던지지 않는다"는 아인슈타인과 "신더러 이래라저래라 하지 말라"는 보어 — 실재의 본성을 둘러싼 20세기 최대의 지적 대결이었다.',
      changed:'논쟁은 1930년 제6차 회의까지 이어져 보어의 판정승으로 기울었지만, 아인슈타인의 불복은 훗날 EPR 논문과 양자정보과학으로 이어진다.'
    },
    phases:[
      {from:1927, to:1929, note:'제5차 회의(1927) — 불확정성 원리를 둘러싼 조찬장 공방'},
      {from:1930, to:1930, note:'제6차 회의(1930) — 아인슈타인의 "빛 상자"를 보어가 상대성이론으로 반박'}
    ],
    figures:[{name:'알베르트 아인슈타인', role:'양자역학 비판'},{name:'닐스 보어', role:'코펜하겐 해석 수호'}]
  },
