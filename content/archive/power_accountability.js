...
,
    ...
    {
      id: 'won_hee_ryong_yangpyeong',
      type: 'political',
      format: 'case_tracking',
      year: 2023, month: 5, day: null,
      title_ko: '원희룡 양평고속도로 종점 변경·백지화 의혹',
      title_en: 'Won Hee-ryong Yangpyeong Expressway Terminus Controversy',
      place_ko: '경기 양평',
      lat: 37.4917, lng: 127.4874,

      card_map: 'contemporary',

      allegation_status: 'under_investigation',
      ...
      stages: [
        { stage:'예비타당성 조사 통과(원안)', date:'2021', institution:'국토교통부', detail:'종점: 양평군 양서면', result:null },
        { stage:'대안 노선 검토', date:'2023-05', institution:'국토교통부', detail:'종점을 김건희 여사 일가 토지 소재 강상면으로 변경 검토', result:null },
        { stage:'특혜 의혹 제기', date:'2023', institution:'언론·야당', detail:'노선 변경이 김건희 일가에 특혜를 준다는 의혹', result:null },
        { stage:'사업 백지화 선언', date:'2023-07', institution:'원희룡(국토부 장관)', detail:'"인지했다면 장관직·정치생명 걸겠다"', result:null },
        { stage:'김건희 특검 1차 기소', date:'2026', institution:'김건희 특검(민중기)', detail:'국토부 서기관 등 강상면 종점 유도 혐의', result:'7명 기소' },
        { stage:'2차 종합특검 수사 개시', date:'2026', institution:'종합특검(권창영)', detail:'원희룡 전 장관의 백지화 선언·직권남용 여부로 수사 확대', result:null },
        { stage:'법 위반 자문 은폐 정황 확인', date:'2026-06', institution:'종합특검', detail:'국토부가 백지화 선언 관련 법 위반 소지 자문을 받고도 반대로 발표', result:null },
        { stage:'대통령실 개입 정황', date:'2026-07', institution:'종합특검', detail:'국토부 해명자료를 대통령실이 작성해 하달했다는 서기관 진술 확보', result:null },
        { stage:'출석요구 송달 실패', date:'2026-07', institution:'종합특검', detail:'두 차례 모두 폐문부재', result:null },
        { stage:'출국금지', date:'2026-07-17', institution:'종합특검', detail:null, result:'출국금지 조치' },
        { stage:'신체·차량 압수수색', date:'2026-07', institution:'종합특검', detail:'휴대전화 확보', result:'직권남용 권리행사방해 혐의 피의자 적시' }
      ],

      legacy_ko: '이 사건은 이 글을 쓰는 시점 아직 수사 중이며, 원희룡 전 장관에 대한 기소·재판 여부는 확정되지 않았다. 다만 이미 확정된 사실만으로도 물음이 남는다 — 예비타당성 조사를 통과한 노선이 왜 특정 개인의 소유지 방향으로 재검토됐는지, 그 재검토를 "백지화"로 되돌린 장관의 선언이 실제로는 위법성 자문을 받고도 반대로 발표된 것이었다면 그 선언의 진정성을 어떻게 봐야 하는지. 국토부 해명자료 작성에 대통령실이 개입했다는 정황이 사실로 확정되면, 이 사건은 개별 부처의 정책 판단이 아니라 대통령실 차원의 개입 사건으로 성격이 바뀐다. 무죄추정의 원칙에 따라 원희룡 전 장관은 유죄가 확정되기 전까지 무죄로 추정되며, 이 항목은 수사 진행에 따라 계속 갱신될 것이다.',

      sources: [
        { type:'newspaper', name:'양평 고속도로 원희룡 신체·차량 압색 휴대전화 확보···종합특검 직권남용 피의자 적시', publisher:'경향신문', author:'', year:'2026', url:'' },
        { type:'newspaper', name:'원희룡 양평 백지화 선언 국토부 법 위반 자문받고도 숨겼다', publisher:'헤럴드경제', author:'', year:'2026', url:'' },
        { type:'newspaper', name:'원희룡 또 폐문부재...특검, 대통령실 양평고속도로 개입 의혹 수사 확대', publisher:'시사타파뉴스', author:'', year:'2026', url:'' },
        { type:'newspaper', name:'종합특검, 양평고속道 의혹 관련 원희룡 전 장관 출국금지', publisher:'데일리안', author:'', year:'2026', url:'' },
      ],

      related: {
        people: [
          { title:'원희룡', url:'' }, { title:'김건희', url:'' }
        ],
        events: [
          { title:'김건희 디올백·매관매직 사건', url:'kim_keon_hee_dior_bag.html' }
        ],
        institutions: ['국토교통부','김건희 특검(민중기)','종합특검(권창영)'],
        archives: [], books: [], videos: [], artworks: [], films: [], music: []
      },
    ...
    {
      id: 'legoland_choi_moon_soon',
      type: 'political',
      format: 'case_tracking',
      year: 2011, month: 4, day: null,
      title_ko: '레고랜드 사태 — 최문순의 추진과 김진태의 보증거부',
      title_en: 'The Legoland Crisis — From Choi Moon-soon\'s Push to Kim Jin-tae\'s Default',
      place_ko: '강원 춘천 중도',
      ...
      body_ko: '2011년 4월 재보궐선거로 취임한 최문순 강원도지사는 영국 멀린엔터테인먼트와 합작으로 레고랜드 코리아를 춘천시 중도(의암호 안의 섬)에 유치하기로 하고, 특수목적법인 엘엘개발(현 강원중도개발공사, GJC)을 설립했다. 그해 8월 투자합의각서(MOA)를 체결할 당시부터 명분은 "지역경제 활성화와 외자 유치"였다. 그러나 2014년 7월 중도에서 고인돌 101기를 포함한 청동기시대 유구 1,400여 기가 발굴되면서 국내 고고학계 사상 최대 규모급 유적 논란이 불거졌다 — 국회에서 "야만의 현장"이라는 비판까지 나왔지만, 최 지사는 사업을 강행했다.\n\n사업 추진 과정에서 강원도에 불리한 계약이 잇따랐다. 2020년 7월 총괄개발협약(MDA) 체결 과정에서 강원도가 받기로 한 임대수익 배분율이 애초 알려진 30.8%에서 3%로 축소되는 밀실합의가 이뤄졌고, 시공사를 STX건설에서 현대건설로 교체하는 과정에서는 강원도가 STX의 손해배상 소송을 막기 위해 별도 공사를 수의계약으로 몰아주는 특혜 논란도 일었다. 우여곡절 끝에 2022년 5월 레고랜드 코리아가 개장했다.\n\n같은 해 6월 지방선거로 최문순의 뒤를 이어 취임한 김진태 지사는 3개월 만인 9월 28일, GJC가 발행한 자산유동화기업어음(ABCP) 2,050억 원에 대한 강원도의 지급보증 이행을 거부하고 GJC의 기업회생을 신청하겠다고 전격 발표했다. 금액 자체는 크지 않았지만 "지자체 보증도 못 믿는다"는 공포가 전국 채권시장으로 번지며 부동산 PF·단기자금시장 전반이 얼어붙었고, 정부와 한국은행은 채권시장안정펀드 등을 통해 수십조 원 규모의 유동성을 긴급 투입해야 했다. 여론의 거센 비판 속에 강원도는 그해 12월 초 보증채무 전액 상환을 의결하고 회생신청을 철회했다.\n\n2년 뒤인 2024년 11월, 춘천지검은 강원도청 감사위원회·투자유치과·문화재유산과를 압수수색하며 강제수사에 착수했다. 검찰은 최문순이 2014년 도의회에 거짓 정보를 제공해 보증 지급 합의서를 작성하게 했고, 부지를 GJC에 헐값에 매각했다가 비싸게 되사들이도록 지시해 강원도에 손해를 입혔다고 보고, 국고손실·업무상배임·위계공무집행방해 혐의로 그를 재판에 넘겼다. 최문순은 소환 조사에서 "도민의 이익을 위한 가치투자였다"며 혐의를 전면 부인했다. 2025년 9월 첫 재판이 열렸고, 이 글을 쓰는 시점까지 재판은 진행 중이며 유죄 확정 여부는 아직 나오지 않았다. 한편 김진태의 보증거부 자체는 범죄 혐의가 성립하지 않아 형사수사 대상이 되지 않았다 — 도지사 권한 안의 정책 판단이었기 때문이다.',

      stages: [
        { stage:'레고랜드 유치 MOA 체결', date:'2011-08', institution:'최문순(강원도지사)', detail:'멀린엔터테인먼트와 합작, 엘엘개발(現 GJC) 설립', result:null },
        { stage:'청동기 유적 발굘·유적지 논란', date:'2014-07', institution:'매장문화재 발굴기관', detail:'고인돌 101기 등 1,400여 기 확인, 국회 "야만의 현장" 비판', result:null },
        { stage:'도의회 거짓 정보 제공 의혹', date:'2014', institution:'최문순(강원도지사)', detail:'검찰: 보증 지급 합의서 작성 유도', result:null },
        { stage:'총괄개발협약(MDA) 밀실합의', date:'2020-07', institution:'강원도·멀린엔터테인먼트', detail:'임대수익 배분 30.8%→3%로 축소', result:null },
        { stage:'레고랜드 코리아 개장', date:'2022-05', institution:'강원중도개발공사(GJC)', detail:null, result:'개장' },
        { stage:'ABCP 지급보증 이행거부·회생신청 발표', date:'2022-09-28', institution:'김진태(강원도지사)', detail:'2,050억 원 규모, 전국 채권시장 신용경색 촉발', result:null },
        { stage:'정부·한은 긴급 유동성 투입', date:'2022-10', institution:'기획재정부·한국은행', detail:'채권시장안정펀드 등 수십조 원 규모', result:null },
        { stage:'보증채무 전액 상환·회생신청 철회', date:'2022-12', institution:'강원도', detail:null, result:'상환 의결·철회' },
        { stage:'검찰 압수수색(강제수사)', date:'2024-11-12', institution:'춘천지방검찰청', detail:'강원도청 감사위원회·투자유치과·문화재유산과', result:null },
        { stage:'최문순 기소', date:'2024', institution:'춘천지방검찰청', detail:'국고손실·업무상배임·위계공무집행방해', result:'기소' },
        { stage:'첫 재판', date:'2025-09', institution:'법원', detail:'최문순, 혐의 전면 부인("도민 이익 위한 가치투자")', result:'재판 진행 중' },
      ],

      legacy_ko: '이 사건은 흔히 "레고랜드 사태"라는 이름으로 2022년 9월의 신용경색만 기억되지만, 실제로는 2011년부터 이어진 세 개의 서로 다른 국면이 겹친 결과다 — ①최문순의 유적지 강행과 불리한 계약 체결(2011~2020), ②그 결과물의 개장(2022년 5월), ③김진태의 보증 이행거부가 촉발한 전국적 신용경색(2022년 9월). 이 글을 쓰는 시점 최문순은 배임 등 혐의로 재판 중이며 유죄가 확정되지 않았으므로 무죄로 추정된다. 반면 사태를 전국적으로 키운 김진태의 판단은 형사처벌 대상 자체가 아니다 — 위법행위가 아니라 정책적 무모함이었기 때문이다. 이 비대칭이 이 사건의 핵심 질문을 남긴다: 유적을 갈아엎고 불리한 계약에 서명한 사람과, 그 부담을 시장 전체에 폭탄 돌리기 하듯 떠넘긴 사람 — 법적 책임을 물을 수 있는 쪽과 실제로 더 파장이 컸던 쪽이 서로 다르다는 것.',

      sources: [
        { type:'newspaper', name:'검찰 \'레고랜드 부당 지원, 최문순 전 지사 고발\' 관련 강제수사 착수', publisher:'노컷뉴스', author:'', year:'2024', url:'' },
        { type:'newspaper', name:'세금으로 갚은 레고랜드 2,050억 원...최문순 전 강원지사 첫 재판', publisher:'YTN', author:'', year:'2025', url:'' },
        { type:'newspaper', name:'\'레고랜드 배임\' 최문순, 검찰 출석 "도민 위한 투자" 반박', publisher:'MBC강원영동', author:'', year:'2024', url:'' },
        { type:'newspaper', name:'검찰, 레고랜드 강제수사 개시', publisher:'자유일보', author:'', year:'2024', url:'' },
        { type:'archive', name:'레고랜드 사태 — 나무위키', publisher:'', author:'', year:'', url:'' },
      ],

      related: {
        people: [
          { title:'최문순', url:'' }, { title:'김진태', url:'' }
        ],
        events: [
          { title:'레고랜드 사태 — 지방정부발 신용경색 (2022)', url:'../../maps/contemporary/index.html?event=economic_2022_03' }
        ],
        institutions: ['강원도청','강원중도개발공사(GJC)','춘천지방검찰청','기획재정부','한국은행'],
        archives: [], books: [], videos: [], artworks: [], films: [], music: []
      },
