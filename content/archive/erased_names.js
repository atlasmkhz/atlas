...
const ARCHIVE_SERIES_ERASED_NAMES = {
  ...
  posts: [
    ...
    // ── 5. 양세봉 — 남북이 함께 기렸기에 오히려 잊힌 사령관 ──────
    {
      id: 'yang_se_bong',
      type: 'person',
      format: 'narrative',
      year: 1934, month: 9, day: 19,
      title_ko: '양세봉 — 남과 북이 함께 기렸기에, 오히려 잊혔다',
      place_ko: '환인현 소황구',
      lat: 41.2700, lng: 125.3600,
      card_ref: 'person_1934_02',
      card_map: 'root',
      ...
      rebuttal_ko: null,
      sources: [
        { type:'archive', name:'한국독립운동인명사전 — 양세봉', publisher:'독립기념관 한국독립운동정보시스템', author:'', year:'', url:'' },
        { type:'archive', name:'한국민족문화대백과사전 — 양세봉', publisher:'한국학중앙연구원', author:'', year:'', url:'' },
        { type:'archive', name:'우리역사넷 — 조선 혁명군', publisher:'국사편찬위원회', author:'', year:'', url:'' },
        { type:'book', name:'조선혁명군 총사령관 양세봉', publisher:'', author:'조문기', year:'2010', url:'' },
        { type:'newspaper', name:'남과 북이 모두 기리는 양세봉 장군, 유일의 역설', publisher:'오마이뉴스', author:'', year:'2020', url:'' },
        { type:'newspaper', name:'다시쓰는 독립운동열전 — 조선혁명군 총사령관 양세봉', publisher:'경향신문', author:'', year:'2005', url:'' },
      ],
      related: {
        events: [
          { title:'양세봉 — 남만주 최후의 사령관 (1934)', url:'../../map.html?event=person_1934_02' },
          { title:'영릉가 전투 — 한중연합군의 승리 (1932)', url:'../../map.html?event=battle_1932_03' },
          { title:'흥경성 전투 (1933)', url:'../../map.html?event=battle_1933_03' },
        ],
        people: [
          { title:'양세봉', url:'' }, { title:'김학규', url:'' }
        ],
        archives: [], books: [],
        videos: [
          { title:'크리스마스 캐롤 〈겨울을 건너〉 — 독립운동가·민주화 영웅', url:'https://www.youtube.com/watch?v=sXfwsXNtiHE' },
          { title:'독립군가 (AI 4K 복원)', url:'https://www.youtube.com/watch?v=NHwoPJJwEXQ' },
        ],
