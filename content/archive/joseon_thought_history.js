...
const ARCHIVE_SERIES_JOSEON_THOUGHT = {
  ...
  color: '#6b5b3e',
  hero_image: null,
  updated: '2026-08-01',   // NEW 배지(7일) 판정용 — 포털·지도 자료실 공통
  ...
  posts: [
    ...
    // ── 18. 송시열과 예학 ───────────────────────────────────
    {
      ...
      related: {
        ...
        people: [], books: [], videos: [], artworks: [], films: [], music: [],
        archives: [{ title:'조선 붕당사 — 예송논쟁', url:'../joseon-faction-history/bd_06_yesong.html' }],
      },
    },
